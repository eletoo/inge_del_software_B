...
\begin{frame}{Test Classe Categoria}
    ...
    \note{
        ...
        Sarebbe diversamente stato complesso testare classi che richiedessero l'input da parte dell'utente. \\\bigskip
...
\begin{frame}{Test Classe Orario}
    ...
    \note{
        ...
        Abbiamo applicato volutamente un testing ``superficiale'' sulla versione 5 in modo da poter mostrare l'evoluzione della tecnica utilizzata: \\
